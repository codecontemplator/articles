...
On [Paul Nylander's awesome page for mathematical artwork](http://www.bugman123.com/Math/index.html) you can find one [^1]  along with some mathematica code to construct it. This article explains how to make one in Blender. There are ofcourse many ways to do it and this approach
